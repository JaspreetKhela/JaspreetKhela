...
- [Learning & Capabilities Map](#quick-access-webpage-links)
  ...
  - [Creative & Expressive Systems: Multimedia Training and Development](#multimedia-training-and-development-title)
  - [Creative & Expressive Systems: Performance Arts Training and Development](#performance-arts-training-and-development-title)
- [Contact](#contact)
...
The map is organized around six pillars. The first is Foundations, which covers theory and cognition and includes both academic growth and personal development. Physical Systems focuses on skilled trades and hardware work. Digital Systems centers on building software. Information & Decision Systems addresses data, analysis, and decision-making. Organizational Systems looks at how businesses operate and improve. Creative & Expressive Systems covers multimedia, arts, and performance. The flow moves from cultivating mental models, to manipulating the physical world, to building in code, to deriving insight, to steering collective effort, and then to rendering meaning. Each quick-access page follows a single-category course structure (Foundations/Theory, Applied/Projects, Tools/Stack, Practice/Assessment, Integration/Capstone) so you can jump into the layer you need.
